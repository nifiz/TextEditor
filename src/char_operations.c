...
uint32 last_character_in_string_CHARINFO(const CHAR_INFO* P_STR, const uint32 SIZEOFSTR, const unsigned char WHITESPACE) {
    ...
    if (P_STR->Char.AsciiChar == NULL || SIZEOFSTR < 1) return 0;
